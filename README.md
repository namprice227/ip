# Charlie project template

This is a project template for a greenfield Java project. It's named after the Java mascot _Charlie_. Given below are
...
1. After that, locate the `src/main/java/Charlie.java` file, right-click it, and choose `Run Charlie.main()` (if the
   code
